    ...
    <section id="inicio" className="relative pt-32 pb-32 overflow-hidden min-h-[600px]">
      ...
      <div className="container max-w-4xl mx-auto px-4 text-center relative z-10">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/30 bg-primary/10 mb-8">
          ...
          <span className="text-sm text-primary/90">Especializado nas áreas do Direito Bancário, Execuções e Direito do Agronegócio</span>
        </div>
        ...
        <p className="text-muted-foreground text-lg max-w-2xl mx-auto mb-10">
          Atendimento humanizado e personalizado. Experiência em negociações com bancos e planejamento de reorganização financeira. Áreas de atuação do Direito Bancário, Execuções e Direito do Agronegócio.
        </p>
